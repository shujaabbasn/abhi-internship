#tts.py (number->word, for speech output)
#backend_logic.py (word->number, for parsing spoken/typed amounts).
URDU_ONES={
...
URDU_MAGNITUDES={100:"سو",1000:"ہزار",100000:"لاکھ",10000000:"کروڑ"}

def urdu_words_to_numbers():
    words_to_numbers={}
    for value, word in URDU_ONES.items():
        words_to_numbers[word]=value
    for value,word in URDU_MAGNITUDES.items():
        words_to_numbers[word]=value
    return words_to_numbers