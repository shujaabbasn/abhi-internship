...
def detect_intent(query):
    ...
    prompt=(
        ...
        'Example 2  User question: send 500 rupees from account 1234567890 to account 12345. Response: {"intent": "send_money", "fields": {"amount": "500", "currency": "pkr", "from_account": "1234567890", "recipient_account": "12345"}}. '
        ...
        'Example 7  User question: move 2000 pkr from my account 1234567890 to my other account 9876543210. Response: {"intent": "send_money", "fields": {"amount": "2000", "currency": "pkr", "from_account": "1234567890", "recipient_account": "9876543210"}}. '
