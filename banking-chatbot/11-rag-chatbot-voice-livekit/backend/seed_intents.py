...
demo_intents=[
    ...
    {
        "name": "send_money",
        "description": "user wants to send or transfer money to any account (always in PKR, this is a Pakistani bank)",
        "required_fields": ["amount", "from_account", "recipient_account"],
        "func_name": "send_money",
        "examples": [
            {"question": "send 500 rupees from account 1234567890 to account 12345", "fields": {"amount": "500", "from_account": "1234567890", "recipient_account": "12345"}, "language": "en"},
            {"question": "I want to send money", "fields": {}, "language": "en"},
